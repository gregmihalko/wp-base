...
set :wp_user, "greg" # The admin username
set :wp_email, "greg@partnerandpartners.com" # The admin email address
set :wp_sitename, "WP Base" # The site title
set :wp_localurl, "http://localhost/wp-base" # Your local environment URL

############################################
# Setup project
############################################

set :application, "wp-base"
set :repo_url, "git@github.com:gregmihalko/wp-base.git"
set :scm, :git
